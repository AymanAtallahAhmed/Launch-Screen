...
class OvalLayer: CAShapeLayer {
  ...
  var ovalPathLarge: UIBezierPath {
    return UIBezierPath(ovalIn: CGRect(x: 2.5, y: 17.5, width: 135.0, height: 135.0))
  }
  
  var ovalPathSquishVertical: UIBezierPath {
    return UIBezierPath(ovalIn: CGRect(x: 2.5, y: 20.0, width: 135.0, height: 130.0))
  }
  
  var ovalPathSquishHorizontal: UIBezierPath {
    return UIBezierPath(ovalIn: CGRect(x: 5.0, y: 20.0, width: 130.0, height: 130.0))
  }
